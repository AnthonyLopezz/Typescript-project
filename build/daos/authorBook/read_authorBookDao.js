    ...
    static get(sqlQuery, parameter, res) {
        return __awaiter(this, void 0, void 0, function* () {
            connectionDB_1.default.result(sqlQuery, parameter)
                ...
                .catch((err) => {
                console.log('Error at getauthorBook: ', err);
                res.status(400).json({ response: 'Did not work at get author Book!' });
            });
        });
    }
}
exports.default = Read_authorBookDao;
